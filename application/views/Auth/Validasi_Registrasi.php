	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login card -->
				<form class="login-form form-validate" action="<?= base_url(); ?>Auth/save" method="post">
					<div class="card mb-0">
						<div class="card-body">
							...
							<?php if (count($result) === 6){ ?>
							<div class="alert alert-danger border-0 alert-dismissible">
							No. Pekerja Yang Anda Masukkan<span class="font-weight-semibold"> Tidak Terdaftar!</span>
							</div>
							<a href="<?= base_url(); ?>Auth/Registrasi" class="btn btn-success btn-block"><i class="icon-circle-left2 ml-2"></i> Kembali</a>
							<?php }elseif (count($result) > 6){ ?>
							<label>Nama</label>
							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="text" class="form-control" name="Nama" placeholder="Nama" value="<?= $result['NAMA'] ?>" readonly required>
							...
							<label>Email</label>
							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="email" class="form-control" name="Email" placeholder="Email" value="<?= $result['NO_BADGE'] ?>@pkc.com" readonly required>
								<div class="form-control-feedback">
							...
							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="text" class="form-control" name="Username" placeholder="Username" value="<?= $result['NO_BADGE'] ?>" readonly required>
								<div class="form-control-feedback">
							...
							<div class="text-muted mb-2">
								<p>Apakah data akun diatas sudah benar?</p>
							</div>
