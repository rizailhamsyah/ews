	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login card -->
				<form class="login-form form-validate" action="<?= base_url(); ?>Auth/authentication" method="post">
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<img src="<?= base_url(); ?>global_assets/images/logo_300.png" width="100px">
								<h5 class="mb-0">Login Early Warning System</h5>
							</div>
							<div class="row">
								<div class="col-lg-12">
									<!-- Falshdata notif -->
							...
							<div class="form-group">
								<button type="submit" class="btn btn-success btn-block">Login <i class="icon-circle-right2 ml-2"></i></button>
							</div>
							<div class="text-center">
								<p>Jika belum memiliki akun silahkan <a href="<?= base_url(); ?>Auth/Registrasi">Registrasi Akun</a> terlebih dahulu</p>
							</div>
						</div>
					</div>
				</form>
